...
PITCHER_P3 = {
    ...
    # 구종 이름 영역 (각 셀 좌측 75%)
    "pitch1_name":  (0.080, 0.580, 0.319, 0.107),
    "pitch2_name":  (0.505, 0.580, 0.319, 0.107),
    "pitch3_name":  (0.080, 0.687, 0.319, 0.107),
    "pitch4_name":  (0.505, 0.687, 0.319, 0.107),
    "pitch5_name":  (0.080, 0.793, 0.319, 0.107),
    # 구종 등급 배지 영역 (각 셀 우측 18%)
    "pitch1_grade": (0.429, 0.580, 0.077, 0.107),
    "pitch2_grade": (0.854, 0.580, 0.077, 0.107),
    "pitch3_grade": (0.429, 0.687, 0.077, 0.107),
    "pitch4_grade": (0.854, 0.687, 0.077, 0.107),
    "pitch5_grade": (0.429, 0.793, 0.077, 0.107),
}
