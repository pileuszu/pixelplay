...
# [항목명  [▸▸▸▸]  E]  ← 바: 총 4칸 (0~4), 등급 E 는 무시
POTENTIAL_BAR_TOTAL = 4

BATTER_P2 = {
    # 전체 행 (없는 지 확인 용)
    "fullswing":        (0.06, 0.490, 0.42, 0.055),  # 1행 좌: 풀스윙
    "bunt":             (0.52, 0.490, 0.42, 0.055),  # 1행 우: 번트
    "clutch":           (0.06, 0.548, 0.42, 0.055),  # 2행 좌: 클러치
    "throw":            (0.52, 0.548, 0.42, 0.055),  # 2행 우: 송구
    "steal":            (0.06, 0.606, 0.42, 0.055),  # 3행 좌: 도루
    # 레벨 바 (파란 칸 수 카운트 → 0~4)
    "fullswing_bar":    (0.14, 0.497, 0.26, 0.038),
    "bunt_bar":         (0.60, 0.497, 0.26, 0.038),
    "clutch_bar":       (0.14, 0.555, 0.26, 0.038),
    "throw_bar":        (0.60, 0.555, 0.26, 0.038),
    "steal_bar":        (0.14, 0.613, 0.26, 0.038),
}
...
PITCHER_P2 = {
    # 전체 행
    "suppress_hr":      (0.06, 0.490, 0.42, 0.055),  # 1행 좌: 장타억제력
    "fastball_type":    (0.52, 0.490, 0.42, 0.055),  # 1행 우: 속구구종
    "composure":        (0.06, 0.548, 0.42, 0.055),  # 2행 좌: 침착성
    "breaking_type":    (0.52, 0.548, 0.42, 0.055),  # 2행 우: 변화구구종
    "pickoff":          (0.06, 0.606, 0.42, 0.055),  # 3행 좌: 견제
    # 레벨 바
    "suppress_hr_bar":  (0.14, 0.497, 0.26, 0.038),
    "fastball_bar":     (0.60, 0.497, 0.26, 0.038),
    "composure_bar":    (0.14, 0.555, 0.26, 0.038),
    "breaking_bar":     (0.60, 0.555, 0.26, 0.038),
    "pickoff_bar":      (0.14, 0.613, 0.26, 0.038),
}
