...
# 타자 Page 2 - 스킬 (최대 4개)
# [스킬명  [◀▸▸▸▸]  등급]  ← 레벨 바: 총 4칸, 채워진 칸 수 = 레벨 (0~4)
SKILL_BAR_TOTAL = 4   # 레벨 바 총 칸 수 (색상 감지로 카운트)

BATTER_P2 = {
    # 스킬 전체 영역 (비어있는지 확인 → 스킬 보유 여부)
    "skill_1":      (0.06, 0.490, 0.90, 0.055),  # 슬롯 1 전체
    "skill_2":      (0.06, 0.548, 0.90, 0.055),  # 슬롯 2 전체
    "skill_3":      (0.06, 0.606, 0.90, 0.055),  # 슬롯 3 전체
    "skill_4":      (0.06, 0.664, 0.90, 0.055),  # 슬롯 4 전체
    # 레벨 바만 (파란 칸 수 카운트 → 0~5)
    "skill_1_bar":  (0.22, 0.497, 0.58, 0.038),  # 슬롯 1 레벨 바
    "skill_2_bar":  (0.22, 0.555, 0.58, 0.038),  # 슬롯 2 레벨 바
    "skill_3_bar":  (0.22, 0.613, 0.58, 0.038),  # 슬롯 3 레벨 바
    "skill_4_bar":  (0.22, 0.671, 0.58, 0.038),  # 슬롯 4 레벨 바
}
...
# 투수 Page 2 - 스킬 (최대 4개)
PITCHER_P2 = {
    "skill_1":      (0.06, 0.490, 0.90, 0.055),
    "skill_2":      (0.06, 0.548, 0.90, 0.055),
    "skill_3":      (0.06, 0.606, 0.90, 0.055),
    "skill_4":      (0.06, 0.664, 0.90, 0.055),
    "skill_1_bar":  (0.22, 0.497, 0.58, 0.038),
    "skill_2_bar":  (0.22, 0.555, 0.58, 0.038),
    "skill_3_bar":  (0.22, 0.613, 0.58, 0.038),
    "skill_4_bar":  (0.22, 0.671, 0.58, 0.038),
}
